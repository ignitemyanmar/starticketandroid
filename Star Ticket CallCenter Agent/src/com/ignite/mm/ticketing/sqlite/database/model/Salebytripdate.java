...
public class Salebytripdate {
	...
	public String toString() {
		return "Salebytripdate [orderId=" + orderId + ", date=" + date
				+ ", departureDate=" + departureDate + ", tripId=" + tripId
				+ ", from=" + from + ", to=" + to + ", extraDestinationId="
				+ extraDestinationId + ", operatorId=" + operatorId
				+ ", operator=" + operator + ", trip=" + trip + ", time="
				+ time + ", _class=" + _class + ", agentId=" + agentId
				+ ", agentCodeNo=" + agentCodeNo + ", customerName="
				+ customerName + ", customerNrc=" + customerNrc
				+ ", customerPhone=" + customerPhone + ", ticketNo=" + ticketNo
				+ ", seatNo=" + seatNo + ", passengers=" + passengers
				+ ", price=" + price + ", ticketQty=" + ticketQty
