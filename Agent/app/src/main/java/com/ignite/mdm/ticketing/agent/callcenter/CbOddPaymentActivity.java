...
public class CbOddPaymentActivity extends BaseSherlockActivity {
	...
	private final String BASE_URL = "http://mdm.starticketmyanmar.com/cbodd-payment/"; 
	...
	private class CbOddPaymentWebViewClient extends WebViewClient{
		...
		public void onPageStarted(WebView view, String url, Bitmap favicon) {
			...
			dialog = ProgressDialog.show(CbOddPaymentActivity.this, "",getString(R.string.please_wait), true);
			ProgressBar progress = (ProgressBar)dialog.findViewById(android.R.id.progress);
			progress.getIndeterminateDrawable().setColorFilter(getResources().getColor(R.color.primary),android.graphics.PorterDuff.Mode.SRC_ATOP);
