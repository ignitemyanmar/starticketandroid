...
@SerializedName("app_operator_id")
@Expose
...
* The app_operator_id
*/
public void setAppOperatorId(String appOperatorId) {
this.appOperatorId = appOperatorId;
}
...
public void setExtra_city(String extra_city) {
	this.extra_city = extra_city;
}
...
public String toString() {
	return "Booking [id=" + id + ", date=" + date + ", departureDate="
			...
			+ ", appOperatorId=" + appOperatorId + ", operator=" + operator
			...
			+ ticketQty + ", extra_city=" + extra_city + "]";
}
