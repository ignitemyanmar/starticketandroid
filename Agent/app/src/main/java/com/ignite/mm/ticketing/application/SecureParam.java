...
public class SecureParam {
	...
	public static native String getOutstandingBooking(String token, String agent_code_no, String date_type,String end_date,String offset,String limit);

	public static native String getOutstandingBooking(String token, String agent_code_no, String date_type,String end_date);
	// Declare native method
	...
	public static native String getInvoices(String accesToken,String agent_code_no,String paydate,String offset);

	public static native String getInvoiceDetail(String access_token,String invoice_id);
