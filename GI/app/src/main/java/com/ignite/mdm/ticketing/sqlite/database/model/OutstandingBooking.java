...
public class OutstandingBooking {

  @SerializedName("sold_ticket_list")
  @Expose
  private List<SoldTicketList> soldTicketList = null;
  ...
  public List<SoldTicketList> getSoldTicketList() {
    return soldTicketList;
  }

  public void setSoldTicketList(List<SoldTicketList> soldTicketList) {
