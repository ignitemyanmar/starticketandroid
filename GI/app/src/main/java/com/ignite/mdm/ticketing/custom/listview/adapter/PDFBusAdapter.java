...
import com.ignite.mdm.ticketing.sqlite.database.model.AllBusObject;
...
public class PDFBusAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			holder.txt_slip_title = (TextView) convertView.findViewById(R.id.txt_slip_title);
			...
			holder.txt_operator_phone = (TextView)convertView.findViewById(R.id.txt_operator_phone);
		...
		holder.txt_slip_title.setText(getItem(position).getAgentGroupName());
	...
	static class ViewHolder {
		...
		TextView txt_slip_title, txt_today_date_time, txt_order_no, txt_passenger, txt_phone, txt_nrc, txt_operator, txt_trip_class;
		TextView txt_trip_date_time, txt_seat_no, txt_ticket_no, txt_price, txt_qty, txt_total, txt_passengers, txt_operator_phone;
	}
