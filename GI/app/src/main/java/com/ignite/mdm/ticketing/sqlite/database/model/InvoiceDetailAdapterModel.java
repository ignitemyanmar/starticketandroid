...
public class InvoiceDetailAdapterModel implements Serializable {
  public String id;
  ...
  public InvoiceDetailAdapterModel(String _class, Integer commission, String customerName,
      String customerPhone, String departureDate, String from, String id, Integer netAmount,
      String remark, String seatNo, Integer seatQty, String time, String to) {
    this._class = _class;
