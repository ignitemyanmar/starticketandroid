...
public class BusSeatAdapter extends BaseAdapter {
  ...
  public View getView(int position, View convertView, ViewGroup parent) {
    ...
    if (list.get(position).getOperatorgroup_color() == 1) {
      ...
      if (list.get(position).getBooking() == 0 && list.get(position).getStatus() == 2) {
        holder.seat.setButtonDrawable(R.drawable.rdo_shape_0);
      } else {
        holder.seat.setButtonDrawable(R.drawable.rdo_shape_0);
    ...
    if (list.get(position).getStatus() == 1 && list.get(position).getOperatorgroup_color() >= 4) {
      holder.layout_customer_info.setVisibility(View.INVISIBLE);
      holder.seatNo.setText(list.get(position).getSeat_no());
      holder.seat.setEnabled(true);
      holder.seat.setTag(position);
    ...
    //}
    //
    //if(list.get(position).getStatus() ==2 && list.get(position).getBooking()== 1){
    //  //booking seat
    //}
    //
    //if(list.get(position).getStatus() ==2 && list.get(position).getBooking()== 0){
    //  //sold seat
    //}
    //
    //if(list.get(position).getStatus() ==0){
    //  //no seat
    //  holder.seat_layout.setVisibility(View.INVISIBLE);
    //}
