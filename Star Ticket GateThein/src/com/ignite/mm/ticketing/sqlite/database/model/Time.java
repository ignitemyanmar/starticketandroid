package com.ignite.mm.ticketing.sqlite.database.model;
	...
	private String time;
	private Integer permitseat_total;
	...
	public Integer getPermitseat_total() {
		return permitseat_total;
	}

	public void setPermitseat_total(Integer permitseat_total) {
		this.permitseat_total = permitseat_total;
	}

	@Override
	public String toString() {
		return "Time [tripid=" + tripid + ", class_id=" + class_id
				+ ", bus_class=" + bus_class + ", total_seat=" + total_seat
				+ ", total_sold_seat=" + total_sold_seat + ", time=" + time
				+ ", permitseat_total=" + permitseat_total + "]";
	}
