...
import com.ignite.mm.ticketing.gatethein.BusBookingListActivity;
import com.ignite.mm.ticketing.gatethein.BusConfirmActivity;
import com.ignite.mm.ticketing.gatethein.BusSeatViewPagerActivity;
import com.ignite.mm.ticketing.gatethein.EditBusSelectSeatActivity;
import com.ignite.mm.ticketing.gatethein.R;
import com.ignite.mm.ticketing.gatethein.R.menu;
...
/*    		if(!BusSeatViewPagerActivity.app_login_user.getUserRole().equals("8")){
    		...
    		if (NetworkEngine.getIp().equals(NetworkEngine.getIp()) || userRole.equals("7")) {
