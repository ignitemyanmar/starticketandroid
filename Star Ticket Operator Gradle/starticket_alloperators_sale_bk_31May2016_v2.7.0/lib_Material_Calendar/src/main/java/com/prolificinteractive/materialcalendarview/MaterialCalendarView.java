...
public class MaterialCalendarView extends ViewGroup {
    ...
    @SuppressLint("NewApi") public MaterialCalendarView(Context context, AttributeSet attrs) {
        super(context, attrs);
     ...
     */
    @SuppressLint("NewApi") public void setSelectionColor(int color) {
        if(color == 0) {
            if(!isInEditMode()) {
                return;
            }
    ...
    @SuppressLint("NewApi") private static int getThemeAccentColor(Context context) {
        int colorAttr;
