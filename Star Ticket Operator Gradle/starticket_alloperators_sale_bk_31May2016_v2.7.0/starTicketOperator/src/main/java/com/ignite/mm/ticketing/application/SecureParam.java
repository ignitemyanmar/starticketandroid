...
public class SecureParam {
	...
	// Declare native method
	public static native String postSaleConfirmParam(String token,String order_id, String ref_id, String ag_id, String ag_name, String name, String ph, String nrc, String rmk_type,String rmk, String ext_dest_id, String lst_seat, String cash, String nation, String or_date, String dev, String bking, String usr_id, String datechange_seatids);
	...
	// Declare native method
	public static native String deleteTicketParam(String token, String id,String date, String seat,String user, String remarkType, String remark);
	// >>>>>>>>>>>>>>>>
	// Declare native method
