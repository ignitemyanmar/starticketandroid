...
@SuppressLint("SimpleDateFormat") public class BusSelectSeatActivity extends BaseSherlockActivity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		txt_dept_date.setText("ထြက္�?ြာမည့္ ေန႕ရက္ : "+ Date);
		txt_dept_time.setText("ထြက္�?ြာမည့္ အ�?်ိန္ : "+ Time);
				...
				try {
					...
					if (jsonObject != null) {
						if(jsonObject.getString("status").equals("1")){
							...
							isBooking = 0;
							dialog.dismiss();
							SKToastMessage.showMessage(BusSelectSeatActivity.this, "အ�?်ိန္ ေနာက္ က် ေနသည့္အ�?ြက္ �?�ယ္ လုိ႔ မရပါ�?�", SKToastMessage.ERROR);
						}
					}
					...
					public void success(Response arg0, Response arg1) {
						...
						if (arg1 != null) {
		    				...
		    				try {
		    					...
		    					//SKToastMessage.showMessage(BusSelectSeatActivity.this, "Your booking is successfully...", SKToastMessage.SUCCESS);
	...
	private void getData() {
		...
		if(BusSeats.size() > 0){
			...
			txt_price.setText("ေစ်း�?ႈန္း :"+ BusSeats.get(0).getSeat_plan().get(0).getPrice()+" Ks");
		...
		public void onClick(View v) {
			...
			if(v == btn_now_booking){
				if(SelectedSeat.length() != 0){
					...
					SKToastMessage.showMessage(BusSelectSeatActivity.this, "�?ံု ေရြးပါ�?�", SKToastMessage.ERROR);
				}
			}
