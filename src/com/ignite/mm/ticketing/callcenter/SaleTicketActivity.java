...
public class SaleTicketActivity extends BaseSherlockActivity{
			...
			// TODO Auto-generated method stub
				if (position > 0) {
					...
					if (selectedFromCity.equals("Choose - From City") || selectedToCity.equals("Choose - To City")) {
						...
						SKToastMessage.showMessage(SaleTicketActivity.this, "�?ရီးစဥ္  အ�?်ိန္မ်ား �?�ကည့္ရန္ သြားမည့္ �?ရီးကုိ ေရြးပါ", SKToastMessage.WARNING);
					}else {
						if(skDetector.isConnectingToInternet()){
							getTripTime();
						}else{
	...
	public boolean checkFields() {
		...
		if (spn_from_trip.getSelectedItem().toString().equals("Choose - From City")) {
			...
			SKToastMessage.showMessage(SaleTicketActivity.this, "�?ရီးစဥ္ ( မွ ) ကုိ ေရြးပါ", SKToastMessage.WARNING);
			return false;
		}
		if (spn_to_trip.getSelectedItem().toString().equals("Choose - To City")) {
			SKToastMessage.showMessage(SaleTicketActivity.this, "�?ရီးစဥ္ ( သုိ႔ ) ကုိ ေရြးပါ", SKToastMessage.WARNING);
			return false;
		}		
