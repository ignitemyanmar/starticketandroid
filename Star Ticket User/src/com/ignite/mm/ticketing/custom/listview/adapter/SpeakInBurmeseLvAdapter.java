...
public class SpeakInBurmeseLvAdapter extends BaseAdapter{

	private LayoutInflater mInflater;
	private List<MenuIcon> lstMenu;

	public SpeakInBurmeseLvAdapter(Activity aty, List<MenuIcon> lstMenu) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (getCount() > 0) {
			ViewHolder holder;
			if(convertView == null){
				convertView = mInflater.inflate(R.layout.list_item_speakburmese, null);
