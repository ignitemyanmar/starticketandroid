...
public class TripAdviseLvAdapter extends BaseAdapter{

	private LayoutInflater mInflater;
	private List<MenuIcon> lstMenu;

	public TripAdviseLvAdapter(Activity aty, List<MenuIcon> lstMenu) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (getCount() > 0) {
			ViewHolder holder;
			if(convertView == null){
				convertView = mInflater.inflate(R.layout.listitem_tripadvise_menu, null);
